...
@Component({
  ...
  templateUrl: './objetosperdidospolicia.component.html',
  styleUrls: ['./objetosperdidospolicia.component.css']
})
export class ObjetosperdidospoliciaComponent  implements OnInit {
